...
def _build_identity_h_pdf(
    ...
    *,
    ...
    font_num = 0 if str(ttf_path).lower().endswith(".ttc") else -1
    full = ttLib.TTFont(str(ttf_path), fontNumber=font_num)
    ...
    sub_font = ttLib.TTFont(str(ttf_path), fontNumber=font_num)
    subsetter = Subsetter()
    subsetter.populate(
